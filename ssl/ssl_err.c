...
static const ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_ADD_SM2_CERT, 0), "ssl_add_sm2_cert"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CKE_SM2ECC, 0),
     "tls_construct_cke_sm2ecc"},
...
static const ERR_STRING_DATA SSL_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_ECC_CERT_NOT_FOR_ENCING),
    "ecc cert not for encing"},
