...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/root/tassl-1.1.1_lib/lib:./

# Path to the openssl distribution
OPENSSL_DIR=.
# Path to the openssl program
OPENSSL_CMD=/root/tassl-1.1.1_lib/bin/openssl
...
# Display the certificate 
$OPENSSL_CMD x509 -sm3 -in $CERTS_DIR/$TEST_SERVER_ENC_FILE.cert.pem -text
